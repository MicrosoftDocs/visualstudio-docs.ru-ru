...
3. На странице параметров **Среда** > **Общие** измените значение **Цветовая тема** на **Темная** и щелкните **ОК**.
...
2. В **мастере импорта и экспорта параметров** выберите **Сбросить все параметры** на первой странице, а затем щелкните **Далее**.

3. На странице **Сохранить текущие параметры** укажите, нужно ли сохранить текущие параметры, а затем щелкните **Далее** (если вы не изменяли параметры, выберите **Нет, только сбросить параметры, перезаписав мои текущие значения**).

4. На странице **Выбор набора параметров, используемого по умолчанию** выберите **Visual Basic**, а затем щелкните **Готово**.

5. На странице **Сброс завершен** щелкните **Закрыть**.
