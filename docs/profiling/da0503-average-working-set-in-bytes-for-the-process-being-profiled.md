...
description: В этом сообщении указывается средний объем физической памяти (в байтах), используемой процессом в данный момент (рабочий набор).
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
- vs.performance.503
