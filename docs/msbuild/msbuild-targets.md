...
description: Узнайте, как MSBuild использует целевые объекты для группировки задач, позволяя разделить процесс сборки на более мелкие этапы.
