...
Добавление имен типов элементов в тип элемента `AvailableItemName` приведет к появлению элементов этого типа в **Обозревателе решений**.
