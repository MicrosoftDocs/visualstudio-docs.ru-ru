...
1. Создайте проект Python в Visual Studio, выбрав **Файл** > **Создать** > **Проект**. Выполните поиск по ключевому слову **Python**, выберите шаблон **Приложение Python**, задайте имя и расположение, а затем нажмите кнопку **OK**.
...
1. Выполните поиск **C++** , выберите **Пустой проект**, укажите либо **superfastcode** для первого проекта, либо **superfastcode2** для второго проекта, а затем нажмите кнопку **OK**.
...
1. Выберите **Файл C++** , задайте для него имя *module.cpp*, а затем нажмите кнопку **OK**.
...
* В другом методе устанавливается модуль в вашей среде Python, что делает этот модуль доступным и для других проектов Python. Дополнительные сведения см. в [документации по проекту **setuptools**](https://setuptools.readthedocs.io/). Выполните следующие действия:
    ...
    1. Выберите **Файл C++ (. cpp)** , назначьте этому файлу имя *setup.py* и нажмите кнопку **OK**.
