...
2. В вашем проекте находится папка с именем проекта. В ней содержатся основные файлы проекта Django.
   ...
   - *wsgi.py* — точка входа для веб-серверов, совместимых с WSGI, для использования в проекте. Обычно этот файл остается без изменений, так как он предоставляет обработчики для рабочих веб-серверов.
