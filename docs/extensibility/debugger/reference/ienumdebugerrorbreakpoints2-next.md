---
description: Возвращает следующий набор элементов из перечисления ошибок и точек останова.
...
`rgelt`\
[вход, выход] Массив элементов [IDebugErrorBreakpoint2](../../../extensibility/debugger/reference/idebugerrorbreakpoint2.md) , которые должны быть заполнены.
