---
description: Этот метод возвращает копию текущего перечисления Идебугобжектс в виде отдельного объекта.
title: 'Иенумдебугобжектс:: Clone | Документация Майкрософт'
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
