---
description: Определяет, что функция по указанному адресу отладки удалена.
title: 'Идебугкомплуссимболпровидер:: Исфунктионделетед | Документация Майкрософт'
ms.date: 11/04/2016
ms.topic: reference
helpviewer_keywords:
...
ms.locfileid: "105095515"
---
# <a name="idebugcomplussymbolproviderisfunctiondeleted"></a>IDebugComPlusSymbolProvider::IsFunctionDeleted
Определяет, что функция по указанному адресу отладки удалена.
