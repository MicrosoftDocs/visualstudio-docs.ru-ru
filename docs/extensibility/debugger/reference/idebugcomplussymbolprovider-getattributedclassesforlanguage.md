---
description: Извлекает классы с указанным атрибутом, реализованным в указанном языке программирования.
...
`guidLanguage`\
окне Уникальный идентификатор для языка.

`pstrAttribute`\
окне Строка атрибута.

`ppEnum`\
заполняет Возвращает перечисление классов атрибутов.
