...
1. Завершите отладку и вернитесь к рабочему экземпляру Visual Studio. Откройте файл *фирсткомманд. CS* и добавьте следующую инструкцию using:
