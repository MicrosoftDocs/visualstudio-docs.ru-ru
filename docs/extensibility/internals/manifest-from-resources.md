...
description: Узнайте, как с помощью средства Manifest from Resources добавить файлы .png или XAML в файл. имажеманифест для использования в службе изображений Visual Studio.
