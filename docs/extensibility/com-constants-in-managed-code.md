...
description: Сведения о платформе управляемых пакетов, которая делает некоторые стандартные константы COM доступными для управляемого кода.
...
## <a name="ole-errors"></a>Ошибки OLE
