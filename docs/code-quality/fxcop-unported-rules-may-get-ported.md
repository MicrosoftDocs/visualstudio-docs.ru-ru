---
description: Следующие правила анализа прежних версий FxCop еще не были реализованы в качестве анализаторов, но все равно могут быть.
title: Неперенесенные правила, которые можно перенести
ms.date: 05/21/2019
ms.topic: reference
helpviewer_keywords:
- fxcop rules
...
ms.locfileid: "102144693"
---
# <a name="unported-rules-that-may-be-ported"></a>Неперенесенные правила, которые можно перенести
