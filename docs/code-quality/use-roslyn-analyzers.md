...
Нарушения правил можно подавлять с помощью различных методов. Дополнительные сведения см. в разделе [подавлять нарушения анализа кода](../code-quality/in-source-suppression-overview.md).
...
- [Подавление предупреждений анализа кода](../code-quality/in-source-suppression-overview.md)
