...
description: Реализация метода содержит пути кода, которые могут вызвать несколько вызовов System. IDisposable. Dispose или эквивалента Dispose, например метод Close для некоторых типов, для одного и того же объекта.
ms.date: 07/16/2019
ms.topic: reference
f1_keywords:
- CA2202
