---
title: Документация по Visual Studio. Новые возможности выпуска за март 2021 г.
titleSuffix: ''
description: Обновления документации Visual Studio за март 2021 г.
ms.date: 04/02/2021
helpviewer_keywords:
...
Узнайте, что изменилось в документации по Visual Studio за март 2021 г. В этой статье перечислены основные изменения, внесенные в документацию в течение этого периода. Сведения об изменениях за предыдущие месяцы см. в [сводке по изменениям](whats-new-visual-studio-docs-history.md).

## <a name="code-quality"></a>Качество кода

**Обновленные статьи**

- [Руководство. Запуск устаревшего анализа кода вручную для управляемого кода](../code-quality/how-to-run-legacy-code-analysis-manually-for-managed-code.md) — подтверждение слияния из рабочей ветви
...
- [Элемент VisibilityItem](../extensibility/visibilityitem-element.md) — подтверждение слияния из рабочей ветви
...
- [Учебник. Начало работы с C# и ASP.NET Core в Visual Studio](../get-started/csharp/tutorial-aspnet-core.md)
  - подтверждение слияния из рабочей ветви;
  - обновление файла tutorial-aspnet-core.md.
...
- [Устранение неполадок и создание журналов по проблемам MSBuild](./msbuild-logs.md) — подтверждение слияния из рабочей ветви
...
- [AndreKraemer](https://github.com/AndreKraemer) — Андре Крэмер (Andre Kraemer) (1)
- [Bouke](https://github.com/Bouke) — Боуке Хаарсма (Bouke Haarsma) (1)
- [Chandankkrr](https://github.com/Chandankkrr) — Чандан Раунийар (Chandan Rauniyar) (1)
- [glenn-slayden](https://github.com/glenn-slayden) — Гленн Слэйден (Glenn Slayden) (1)
- [grossag](https://github.com/grossag) — Адам Гросс (Adam Gross) (1)
- [icnocop](https://github.com/icnocop) — Рами (Rami) (1)
- [mookid](https://github.com/mookid) — Натан Моро (Nathan Moreau) (1)
- [nebuk89](https://github.com/nebuk89) — Бен Де Ст Пер-Готч (Ben De St Paer-Gotch) (1)
- [stanciuadrian](https://github.com/stanciuadrian) — Адриан Станчу (Adrian Stanciu) (1)
- [stegrams](https://github.com/stegrams) — Стефанос Грамменос (Stefanos Grammenos) (1)
