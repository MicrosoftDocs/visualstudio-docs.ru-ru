...
- [Целевые объекты MSBuild](../msbuild/msbuild-targets.md) — MSBuild: уточнение, как расширять и настраивать целевые объекты
- [Метаданные элементов в пакетной обработке задач](../msbuild/item-metadata-in-task-batching.md) — MSBuild: уточнение поведения при пакетной обработке метаданных удостоверений
...
- [Практическое руководство. Добавление и удаление сопоставленных папок](../sharepoint/how-to-add-and-remove-mapped-folders.md) — удаление sp13
- [Практическое руководство. Создание модели подключения к бизнес-данным](../sharepoint/how-to-create-a-bdc-model.md) — удаление sp13
- [Практическое руководство. Создание веб-части SharePoint с помощью конструктора](../sharepoint/how-to-create-a-sharepoint-web-part-by-using-a-designer.md) — удаление sp13
...
Указанные ниже пользователи в течение этого периода внесли свой вклад в улучшение документации по Visual Studio. Спасибо! Сведения о том, как внести свой вклад, см. по ссылкам в разделе "Примите участие" на [целевой странице новых возможностей](index.yml).

- [boop5](https://github.com/boop5) — LSC (1)
- [cdmihai](https://github.com/cdmihai) — Михай Кодобан (Mihai Codoban) (1)
- [hyoshioka0128](https://github.com/hyoshioka0128) — Хироси Йосиока (Hiroshi Yoshioka) (1)
- [isra-fel](https://github.com/isra-fel) — Йеминг Лю (Yeming Liu) (1)
- [Quenty](https://github.com/Quenty) — Джеймс Оннен (James Onnen) (1)
- [ThomasIAm](https://github.com/ThomasIAm) — Томас ван ден Ньювенхофф (Thomas van den Nieuwenhoff) (1)
...
- [Метрики кода — цикломатическая сложность](../code-quality/code-metrics-cyclomatic-complexity.md) — обновлены метрики кода для цикломатической сложности и глубины наследования
- [Метрики кода — глубина наследования (DIT)](../code-quality/code-metrics-depth-of-inheritance.md) — обновлены метрики кода для цикломатической сложности и глубины наследования
- [Анализ кода: вопросы и ответы](../code-quality/analyzers-faq.yml) — FAQ.md преобразован в yml
- [Вопросы и ответы об устаревших анализаторах FxCop и .NET](../code-quality/net-analyzers-faq.yml) — FAQ.md преобразован в yml

**Обновленные статьи**

- [Подавление нарушений анализа кода](../code-quality/in-source-suppression-overview.md) — рефакторинг документации по подавлению правил анализа кода
...
- [Устранение неполадок точек останова в данных](../debugger/troubleshoot-data-breakpoint-errors.md) — обновлена документация об устранении ошибок точки останова
...
- [Условия MSBuild](../msbuild/msbuild-conditions.md) — сравнение версий MSBuild
- [Функции свойств](../msbuild/property-functions.md) — сравнение версий MSBuild
