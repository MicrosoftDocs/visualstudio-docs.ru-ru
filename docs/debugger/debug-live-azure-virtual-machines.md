---
title: Отладка динамических виртуальных машин и масштабируемых наборов Azure в ASP.NET
description: Узнайте, как с помощью Snapshot Debugger в Visual Studio задать точки моментальных снимков и создать моментальные снимки при отладке работающих приложений ASP.NET на виртуальных машинах Azure и в масштабируемых наборах.
...
1. Выберите **Отладка > Подключить Snapshot Debugger...** . Выберите виртуальную машину или масштабируемый набор виртуальных машин Azure, где развернуто ваше веб-приложение, и учетную запись хранения Azure, а затем нажмите кнопку **Подключить**. Snapshot Debugger также поддерживает [Службу Azure Kubernetes](debug-live-azure-kubernetes.md) и [Службу приложений Azure](debug-live-azure-applications.md).
    ...
    > Когда вы впервые запустите действие **Подключить Snapshot Debugger** для Масштабируемых наборов виртуальных машин, каждый экземпляр VMSS придется обновить вручную.
