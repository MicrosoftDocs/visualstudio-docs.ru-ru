...
1. В обозревателе решений щелкните правой кнопкой мыши решение, выберите пункт **Добавить**, а затем щелкните **Новый проект**. В раскрывающемся списке языков выберите **C#** . В поле поиска введите **библиотека классов**, а затем выберите **Библиотека классов (.NET Framework)** или **Библиотека классов** для .NET Standard.
