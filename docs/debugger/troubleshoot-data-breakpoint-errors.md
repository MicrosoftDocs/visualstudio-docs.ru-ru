...
description: Пояснения, решения и возможные методы обхода ошибки "Не удалось задать точку останова в данных", возникающей в режиме "Прервать при изменении значения".
...
> [!IMPORTANT]
> Управляемые точки останова в данных поддерживаются в .NET Core 3.0 и более поздних версий, а также в .NET 5.0.3 и более поздних версий. Скачать последнюю версию можно [здесь](https://dotnet.microsoft.com/download).
...
- *"Используемая целевым процессом версия .NET не поддерживает точки останова в данных. Для них требуется .NET Core 3.x или .NET 5.0.3 или более поздних версий на платформе x86 или x64"*
  ...
  - Управляемые точки останова в данных начали поддерживаться в .NET Core 3.0. На данный момент они не поддерживаются в .NET Framework, версиях .NET Core ниже 3.0 и версиях .NET ниже 5.0.3. 
