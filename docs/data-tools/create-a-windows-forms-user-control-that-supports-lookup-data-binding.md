...
description: Узнайте, как создать Windows Forms пользовательский элемент управления, поддерживающий привязку данных Lookup, с помощью класса Лукупбиндингпропертиесаттрибуте в Visual Studio.
