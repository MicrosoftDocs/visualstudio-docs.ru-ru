...
ms.locfileid: "104671811"
---
# <a name="whitesource-bolt-in-visual-studio-subscriptions"></a>WhiteSource Bolt в подписках Visual Studio

Находите и исправляйте уязвимости в продуктах с открытым исходным кодом и создавайте подробные отчеты об инвентаризации и лицензиях по всем компонентам с открытым исходным кодом в вашей сборке. В рамках подписки Visual Studio Enterprise предоставляется неограниченное количество проверок в течение шести месяцев.
...
6. Затем выберите нужную организацию Azure DevOps и щелкните **Install** (Установить).  (Если вы еще не настроили Azure DevOps Services, посетите страницу [Преимущества](https://my.visualstudio.com/benefits) и активируйте преимущество Azure DevOps Services.)

7. Щелкните **Proceed to organization** (Перейти к организации).
8. После успешной установки WhiteSource Bolt вернитесь на [страницу активации](https://bolt.whitesourcesoftware.com/whitesource-bolt-azure-devops#activate) и просмотрите видео, чтобы узнать, как настроить это средство. 
...
| Подписка Visual Studio Enterprise с GitHub Enterprise | VL | 6 месяцев       |  Да       |
...
<sup>1</sup> *Включает: Microsoft Partner Network (Enterprise).  Не включает: не для перепродажи (NFR), отраслевой партнер Visual Studio (VSIP), FTE, разработчик ПО и служб MCT, BizSpark, Imagine, Most Valuable Professional (MVP), региональный директор (RD).  ПО и службы MCT, не для перепродажи, базовый (NFR Basic).*
