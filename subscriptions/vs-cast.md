...
| Подписка Visual Studio Enterprise с GitHub Enterprise  | VL | Оценка 5 приложений на три месяца|  Нет.  Доступно только для новых подписчиков          |
...
| Подписка Visual Studio Professional с GitHub Enterprise | VL                                       | Оценка 1 приложения на три месяца                                                            |  Нет.  Доступно только для новых подписчиков                  |
