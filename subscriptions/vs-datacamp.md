---
title: Развитие навыков обработки и анализа данных с помощью преимущества DataCamp в подписках Visual Studio | Документация Майкрософт
author: evanwindom
ms.author: v-evwin
manager: cabuschl
...
2. Найдите плитку преимущества DataCamp в категории "Профессиональное развитие" и нажмите кнопку **Активировать**.
   ...
   > ![Плитка преимущества DataCamp](_img/vs-datacamp/vs-datacamp-tile-2.png "Щелкните Активировать, чтобы приступить к работе.")
...
4. Когда учетная запись будет создана, вы можете выбрать схему обучения.  Возможны следующие значения.
   ...
   > [!div class="mx-imgBorder"]
   > ![Выбор схемы в DataCamp](_img/vs-datacamp/vs-datacamp-choose-path.png "Выберите интересующую вас схему обучения.")
...
5. После выбора схемы обучения вы можете уточнить ее, выбрав цель.  Например, если вы выбрали "Развитие навыков обработки и анализа данных", будут доступны представленные ниже варианты. Выберите вариант или щелкните **Я сомневаюсь.  Покажите все карьерные пути**, чтобы создать более широкую схему.
   > [!div class="mx-imgBorder"]
   > ![Набор навыков обработки и анализа данных в DataCamp](_img/vs-datacamp/vs-datacamp-datascience.png "Чтобы просмотреть весь список,  щелкните "I am not sure.")
...
6. В зависимости от выбранной схемы и параметров вы увидите ряд карьерных путей.  Нажмите кнопку **Регистрация** для выбранного пути.
   > [!div class="mx-imgBorder"]
   > ![Карьерный путь в DataCamp](_img/vs-datacamp/vs-datacamp-all-tracks.png "Show me all career paths" (Я сомневаюсь. Покажите все программы карьерного роста).")

7. После регистрации для прохождения программы откроется первый курс.  Вы увидите учебник, в котором объясняется, как работать с курсом, в том числе переходить по нему и выполнять упражнения.

   > [!div class="mx-imgBorder"]
   > ![Начало работы с DataCamp](_img/vs-datacamp/vs-datacamp-getting-started.png "Просмотрите руководство, чтобы узнать, как перемещаться по курсам.")
...
> [!div class="mx-imgBorder"]
> ![Продолжение обучения в DataCamp](_img/vs-datacamp/vs-datacamp-continue-training.png "Щелкните Continue Track (Продолжить обучение по программе), чтобы продолжить обучение в любое время.")
...
| Подписка Visual Studio Enterprise с GitHub Enterprise   | VL | 3 месяца       |  Нет.  Доступно только для новых подписчиков          |
