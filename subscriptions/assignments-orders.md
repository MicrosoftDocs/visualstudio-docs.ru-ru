---
title: Отслеживание назначений и обработка заказов в подписках Visual Studio | Visual Studio Marketplace
author: evanwindom
ms.author: v-evwin
manager: cabuschl
...
Все ваши обязательства по приобретению определяются максимальным числом подписок, назначаемых пользователям. Уровень назначения подписок определяется числом назначений пользователей в день или числом пользователей, использующих программное обеспечение Visual Studio, в зависимости от того, какое из этих двух чисел больше.

- Назначение подписок Visual Studio дополнительному числу пользователей повышает максимальный уровень использования.  
- Администраторы подписок на Visual Studio могут изменить назначенный пользователю уровень подписки. При этом уровень подписки одного пользователя может повыситься, а другого — понизиться. При понижении уровня подписки, назначенного пользователю, он должен немедленно прекратить использование и удалить все компоненты, право на использование которых дает только более высокий уровень подписки. 
- Администраторы подписок Visual Studio могут переназначать подписки другим пользователям, если с момента исходного назначения прошло 90 дней. 
    > [!NOTE]
...
Вы можете назначать подписки с помощью таких программ, как Open License, Open Value, либо через Visual Studio Marketplace на ежемесячной основе. В этом случае вам необходимо разместить заказ на лицензии для дополнительного числа пользователей в течение месяца, в котором пользователи (сотрудники или внешние подрядчики) начали взаимодействовать с программным обеспечением, лицензируемым по подписке на Visual Studio.
