---
title: Parasoft Virtualize/SOAtest Professional в подписках Visual Studio | Документация Майкрософт
author: evanwindom
ms.author: v-evwin
manager: cabuschl
...
2. Найдите плитку "Parasoft" в разделе "Средства" и щелкните ссылку **Получить код** в нижней части плитки преимущества.   Вы увидите уведомление о том, что код успешно получен.  Щелкните **Активировать**.
   ...
   > ![Плитка преимущества Parasoft](_img/vs-parasoft/vs-parasoft-tile.png "На плитке Parasoft щелкните 'Получить код', а затем нажмите кнопку 'Активировать', чтобы приступить к работе.")
...
3. Вы будете перенаправлены на веб-сайт Parasoft, где вы создадите учетную запись.  Просто укажите контактные данные и нажмите кнопку **Отправить**.
   > [!div class="mx-imgBorder"]
   > ![Создание учетной записи для преимущества Parasoft](_img/vs-parasoft/vs-parasoft-new-account.png "Укажите контактные данные и нажмите кнопку 'Отправить', чтобы создать учетную запись.")
...
6. Щелкните ссылку, соответствующую используемой вами операционной системе.
   > [!div class="mx-imgBorder"]
   > ![Приветственное сообщение для преимущества Parasoft](_img/vs-parasoft/vs-parasoft-email.png "Щелкните ссылку для скачивания, соответствующую вашей операционной системе.")
...
10. Запускается мастер установки Parasoft SOAtest и Virtualize.  Нажмите кнопку **Далее**.
    > [!div class="mx-imgBorder"]
    > ![Начало установки преимущества Parasoft](_img/vs-parasoft/vs-parasoft-start-install.png "Нажмите кнопку Next (Далее), чтобы начать установку Parasoft SOAtest & Virtualize.")
