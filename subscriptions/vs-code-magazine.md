...
4. Вы перейдете на целевую страницу CODE Magazine. Выберите страну или регион и способ получения журнала. 
   > [!NOTE]
...
|--------------------------------------------------------------------|---------------------------------------------------------|------------------------------------------------------------------|---------------|
| Visual Studio Enterprise (ценовая категория "Стандартный")   | Корпоративная лицензия, Azure, розничная версия| Доступно       |  Нет          |
| Подписка Visual Studio Enterprise с GitHub Enterprise   | VL| Доступно       |  Нет          |
| Visual Studio Professional (ценовая категория "Стандартный") | Корпоративная лицензия, Azure, розничная версия                                       | Доступно                                                            |  Нет          |
| Подписка Visual Studio Professional с GitHub Enterprise | VL                                      | Доступно                                                            |  Нет          |
...
| Visual Studio Enterprise NFR<sup>1</sup> | NFR | Недоступно | Н/Д |

<sup>1</sup>  *Включает: не для перепродажи (NFR), отраслевой партнер Visual Studio (VSIP), FTE, BizSpark, Imagine, Imagine Premium Microsoft Partner Network (MPN), Most Valuable Professional (MVP), региональный директор (RD), разработчик ПО и служб MCT, ПО и службы MCT.  
