---
title: Решения для поддержки подписок
description: Список файлов INCLUDE для подписок Visual Studio поддерживает содержимое мини-приложения
ms.topic: conceptual
...
ms.locfileid: "111530450"
---
# <a name="visual-studio-subscriptions-support-widget-content-includes-files"></a>Подписки Visual Studio поддерживают содержимое виджета файлов INCLUDE

## <a name="admin-solutions"></a>Решения для администраторов
...
## <a name="benefit-activations"></a>Активация преимуществ
...
## <a name="download-activate-or-use-software"></a>Загрузка, активация или использование программного обеспечения

### <a name="downloads-and-activations"></a>Загрузки и активации
...
### <a name="find-and-use-product-keys"></a>Поиск и использование ключей продуктов
...
### <a name="use-product-features"></a>Использование функций продукта
...
## <a name="other-solutions-or-no-solution"></a>Другие решения или без решения

[!INCLUDE [No solution](other-or-no-solution/includes/no-solution.md)]

## <a name="portal-issues"></a>Проблемы с порталом
...
## <a name="purchase-renew-or-cancel-subscriptions"></a>Покупка, продление или отмена подписок

### <a name="help-with-purchases"></a>Помощь в покупке
...
### <a name="help-with-renewals"></a>Помощь в обновлении
...
### <a name="help-with-canceling"></a>Помощь с отменой
...
### <a name="order-or-purchase-status"></a>Состояние заказа или покупки
...
## <a name="issues-with-signing-in"></a>Проблемы со входом 
