...
## <a name="21000"></a>2.10.0.0 модуля
...
- **Интеграция:**
  ...
  - Устранены проблемы со стабильностью для диагностики [`UNT0018`](https://github.com/microsoft/Microsoft.Unity.Analyzers/blob/main/doc/UNT0018.md).
...
- **Интеграция:**
  ...
  - Исправлена диагностика [`UNT0006`](https://github.com/microsoft/Microsoft.Unity.Analyzers/blob/main/doc/UNT0006.md), которая создавала неверные предупреждения для сопрограмм и `AssetPostprocessor.OnAssignMaterialModel`.
